...
sed -i 's/KERNEL_PATCHVER:=5.15/KERNEL_PATCHVER:=5.15/g' target/linux/rockchip/Makefile  #修改内核版本
sed -i 's/KERNEL_TESTING_PATCHVER:=5.19/KERNEL_TESTING_PATCHVER:=5.18/g' target/linux/rockchip/Makefile  #修改内核版本
