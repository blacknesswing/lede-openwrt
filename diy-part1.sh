...
# wifi驱动R2s
git clone https://github.com/project-openwrt/openwrt/tree/package/ctcgfw/rtl8812au-ac 
git clone https://github.com/project-openwrt/openwrt/tree/package/ctcgfw/rtl8821cu 
git clone https://github.com/project-openwrt/openwrt/tree/package/ctcgfw/rtl88x2bu 
